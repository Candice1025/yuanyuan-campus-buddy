  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-gradient-primary shadow-float flex items-center justify-center hover:scale-110 transition-transform duration-300 animate-float"
        aria-label="荣格助手"
      >
